...
/**
 * Provide a stable DEBUG macro that can be used inline in any build configuration
 */
#ifndef DEBUG
#define DEBUG 0
#endif
...
/**
 * Provide a stable TARGET_IPHONE_SIMULATOR macro that can be used inline in any build configuration
 */
